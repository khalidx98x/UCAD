    ...
    <div class="box-body">
        <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12">
                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                        <thead>
                        <tr role="row">
                            <th class="" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">{{ trans('admin.sub_item_name') }}</th>
        ...
        <div class="col-lg-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> {{ trans('admin.Crate_sub_items') }}</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form">
                    <div class="box-body">
                        ...
                        <div id="addI"></div>
                        <button class="btn btn-primary" type="button" id="btnsubItem" >{{ trans('admin.addSubItem') }}</button>
