        ...
        <div class="col-lg-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('admin.Crate_page') }}</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div>
                                        ...
                                        <a href="javascript:;" class="btn red fileinput-exists btn btn-danger"
                                           data-dismiss="fileinput"> {{ trans('admin.Remove') }} </a>
